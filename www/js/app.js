...
window.globalVariable = {
    ...
    startPage: {
        url: "/app/fakeLogin",//Url of start page.
        state: "app.fakeLogin"//State name of start page.
    },
    message: {
...
angular.module('starter', ['ionic','ngIOS9UIWebViewPatch', 'starter.controllers', 'starter.services', 'ngMaterial', 'ngMessages', 'ngCordova', 'firebase', 'ng', 'angularFileUpload', 'ion-datetime-picker'])
    ...
    .config(function ($ionicConfigProvider, $stateProvider, $urlRouterProvider, $mdThemingProvider, $mdIconProvider, $mdColorPalette, $mdIconProvider) {
        ...
        $stateProvider
            ...
            .state('app.dashboardv2', {
                ...
                views: {
                    'menuContent': {
                        templateUrl: "templates/material-user-interface/dashboardv2/html/dashboard.html",
            ...
            // .state('app.recordExpense', {
            //     url: "/recordExpense",
            //     cache: false,
            //     views: {
            //         'menuContent': {
            //             templateUrl: "templates/material-user-interface/record-expense/html/recordexpense.html",
            //             controller: 'recordExpenseCtrl'
            //         }
            ...
            .state('app.pricing', {
                ...
                views: {
                    'menuContent': {
                        templateUrl: "templates/themes/purchases-reports/html/expense-dashboard.html",
                        controller: "purchasesReportCtrl"
                    }
                }
            })
            ...
            .state('app.donorExpenseReports', {
                url: "/donorExpenseReports",
                views: {
                    'menuContent': {
                        templateUrl: "templates/themes/donor-expreport/html/donor-expreport.html",
                        controller: "donorExpenseReportCtrl"
                    }
                }
            })
            .state('app.expense', {
            ...
            .state('app.newsFeed', {
                ...
                views: {
                    'menuContent': {
                        ...
                        controller: "recordPurchasesCtrl"
                    }
                }
            })
            .state('app.clothShop', {
                ...
                views: {
                    'menuContent': {
                        templateUrl: "templates/themes/donor-budget/html/cloth-shop.html",
            ...
            .state('app.onlineCourse', {
                ...
                views: {
                    'menuContent': {
                        templateUrl: "templates/themes/online-course/html/donorincome-report.html",
            ...
            .state('app.catalog', {
                ...
                views: {
                    'menuContent': {
                        templateUrl: "templates/themes/recordexpense_investor/html/catalog.html",
                        controller: "recordExpenseCtrl"
                    }
                }
            })
            .state('app.catalogv2', {
                ...
                views: {
                    'menuContent': {
                        templateUrl: "templates/themes/catalogv2/html/catalog.html",
                        controller: "recordExpensev2Ctrl"
                    }
                }
            })
            .state('app.locationFeed', {
                ...
                views: {
                    'menuContent': {
                        templateUrl: "templates/themes/location-feed/html/approvedincome-report.html",
                        controller: "approvedIncomeCtrl"
                    }
                    // 'menuContent': {
                    //     templateUrl: "templates/themes/location-feed/html/location-feed.html",
                    //     controller: "recordIncomeCtrl"
                    // }
                }
            })
            .state('app.contacts', {
                ...
                views: {
                    'menuContent': {
                        templateUrl: "templates/themes/contacts/html/contacts.html",
    ...
    .constant('APIBASE', 'https://portal.epesibooks.com/acc/api_v1/')
    .constant('APIBASE_V', 'https://pwc.scopicafrica.com/interpreter/')
    .constant('APIBASE_V_1','https://pwc.scopicafrica.com/pwc/api_v1/')
...
// Initialize Firebase
// var config = {
//     apiKey: "AIzaSyBR5jSzDvTvKW84tmIhGbotGNRrin9E-Sk",
//     authDomain: "pwc-app-24aec.firebaseapp.com",
//     databaseURL: "https://pwc-app-24aec.firebaseio.com",
//     projectId: "pwc-app-24aec",
//     storageBucket: "pwc-app-24aec.appspot.com",
//     messagingSenderId: "47688593382"
// };
// firebase.initializeApp(config);

// var config = {
//     apiKey: "AIzaSyC9TwOGRg7ISIouk5TX8Qitnyv7JWz4Vac",
//     authDomain: "pwc-tester.firebaseapp.com",
//     databaseURL: "https://pwc-tester.firebaseio.com",
//     projectId: "pwc-tester",
//     storageBucket: "pwc-tester.appspot.com",
//     messagingSenderId: "863927001142"
// };
// firebase.initializeApp(config);

// Initialize Firebase
var config = {
    apiKey: "AIzaSyCMZ_CUMkbGZqAtRke07S7gY5aOgSrqipc",
    authDomain: "pwc-testerv2.firebaseapp.com",
    databaseURL: "https://pwc-testerv2.firebaseio.com",
    projectId: "pwc-testerv2",
    storageBucket: "pwc-testerv2.appspot.com",
    messagingSenderId: "577398911899"
};
firebase.initializeApp(config);
