...
appControllers.controller('defaultUserInterfaceCtrl', function(APIBASE, $mdDialog, $mdBottomSheet, $mdToast, $mdDialog, $firebaseArray, $firebaseObject, $scope, $rootScope, $timeout, $http, $filter, $q, $interval, $state, $stateParams, $ionicHistory) {
            ...
            $scope.sellItems = function() {
                ...
                $scope.items.forEach(function(item) {
                    if (item.selected === true) {
                        ...
                        alert($scope.totalSaleAmount)

                        var aa = 444;
                        $timeout(function(aa){
                            //alert(22)
                            $scope.totalSaleAmount = aa;
                            $scope.showConfirmDialog($scope.$event);
                        },1000);
    ...
    $scope.showConfirmDialog = function ($event) {
        $mdDialog.show({ 
            ...
            template:
                ...
                '  <md-dialog-content>'+
                     '<div class="test"><p>TOTAL: KES 11{{totalSaleAmount}}</p></div>'+
            ...
            locals: {
                ...
                // //     content: "<h1>This is confirm dialog content.</h1>",
                //      ok: "Confirm",
                //      cancel: "Close"
                // }
            }
