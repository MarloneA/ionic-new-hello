appControllers.controller('purchasesReportCtrl', function(APIBASE, $mdDialog, $firebaseArray, $firebaseObject, $scope, $rootScope, $timeout, $http, $filter, $q, $interval, $state, $stateParams, $ionicHistory, $ionicScrollDelegate, $location) {
        ...
        $timeout(function(){
            ...
            var showWksTabChart = setInterval(function(){
                ...
                if(showWksTab.length>0){
                    $location.hash('pur-active-tab-pill-button');
            ...
            $timeout(function(){
                ...
                var showMntTabChart = setInterval(function(){
                    ...
                    if(showMthTab.length>1){
                        ...
                        $location.hash('pur-active-tab-pill-button-month');
                        $ionicScrollDelegate.anchorScroll(true);
            ...
            $timeout(function(){
                ...
                var showYrTabChart = setInterval(function(){
                    ...
                    if(showYrTab.length>1){
                        ...
                        $location.hash('pur-active-tab-pill-button-year');
                        $ionicScrollDelegate.anchorScroll(true);
