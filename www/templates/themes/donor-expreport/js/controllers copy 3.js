appControllers.controller('donorExpenseReportCtrl', function(APIBASE, $mdDialog, $firebaseArray, $firebaseObject, $scope, $rootScope, $timeout, $http, $filter, $q, $interval, $state, $stateParams, $ionicHistory, $ionicScrollDelegate, $location) {
   ...
   //Adjust page chart height
    ...
    FBExpensesref.orderByKey().on("value", function(snapshot) {
        ...
        var totalAntenatalCareExpenses = 0;
        var totalPostNatalCareExpenses = 0;
        var totalSelfDeliveryExpenses = 0;
        var totalGenderBasedViolenceExpenses = 0;
        var totalRapeCasesExpenses = 0;
        var totalFamilyPlanningExpenses = 0;
        var totalPrenatalCareExpenses = 0;

        for (var i = 0; i < monthlyExpenses.length; i++) {
            totalExpenses = totalExpenses + monthlyExpenses[i]['amount'];
            if (monthlyExpenses[i]['expType'] === '"Antenatal Care"') {
                totalAntenatalCareExpenses = totalAntenatalCareExpenses + monthlyExpenses[i]['amount'];
            }
            if (monthlyExpenses[i]['expType'] === "PostNatal Care") {
                totalPostNatalCareExpenses = totalPostNatalCareExpenses + monthlyExpenses[i]['amount'];
            }
            if (monthlyExpenses[i]['expType'] === "Self Delivery") {
                totalSelfDeliveryExpenses = totalSelfDeliveryExpenses + monthlyExpenses[i]['amount'];
            }
            if (monthlyExpenses[i]['expType'] === "Gender Based Violence") {
                totalGenderBasedViolenceExpenses = totalGenderBasedViolenceExpenses + monthlyExpenses[i]['amount'];
            }
            if (monthlyExpenses[i]['expType'] === "Rape Cases (GVRC)") {
                totalRapeCasesExpenses = totalRapeCasesExpenses + monthlyExpenses[i]['amount'];
            }
            if (monthlyExpenses[i]['expType'] === "Family Planning") {
                totalFamilyPlanningExpenses = totalFamilyPlanningExpenses + monthlyExpenses[i]['amount'];
            }
            if (monthlyExpenses[i]['expType'] === "Prenatal Care") {
                totalPrenatalCareExpenses = totalPrenatalCareExpenses + monthlyExpenses[i]['amount'];
            }
        }
        ...
        currentWkChart = function(){
            ...
            var currentWeekBarCharts = function(startDate,endDate,fromMonth,toMonth) {
                ...
                totalAntenatalCareExpenses = 0;
                totalPostNatalCareExpenses = 0;
                totalSelfDeliveryExpenses = 0;
                totalGenderBasedViolenceExpenses = 0;
                totalRapeCasesExpenses = 0;
                totalFamilyPlanningExpenses = 0;
                totalPrenatalCareExpenses = 0;
                ...
                console.log('totalAntenatalCareExpenses,totalPostNatalCareExpenses,totalSelfDeliveryExpenses,totalGenderBasedViolenceExpenses,totalRapeCasesExpenses,totalFamilyPlanningExpenses,totalPrenatalCareExpenses');
                console.log(['totalAntenatalCareExpenses'+totalAntenatalCareExpenses,'totalPostNatalCareExpenses'+totalPostNatalCareExpenses,'totalSelfDeliveryExpenses'+totalSelfDeliveryExpenses,'totalGenderBasedViolenceExpenses'+totalGenderBasedViolenceExpenses,'totalRapeCasesExpenses'+totalRapeCasesExpenses,'totalFamilyPlanningExpenses'+totalFamilyPlanningExpenses,'totalPrenatalCareExpenses'+totalPrenatalCareExpenses]);
                // Section 1 Chart 1
                ...
                new Chart('myChart', {
                      ...
                      data: {
                          ...
                          labels: ["AntenatalCare","PostNatalCare","SelfDelivery","GenderBasedViolence","RapeCases","FamilyPlanning","PrenatalCare"],
                          //labels: ["B (" + totalBusinessExpPercent + "%)", "P (" + totalPersonalExpPercent + "%)", "S (" + totalStockExpPercent + "%)"],
                          datasets: [{
                              label: 'WeeklyInit',
                              //data: [12, 19, 3, 5, 2, 3, 9],

                              data: [totalAntenatalCareExpenses, totalPostNatalCareExpenses, totalSelfDeliveryExpenses, totalGenderBasedViolenceExpenses, totalRapeCasesExpenses, totalFamilyPlanningExpenses, totalPrenatalCareExpenses],
                              backgroundColor: [
                                  '#f54525',
                                  '#2980b9',
                                  '#66bbbb',
                ...
                Chart.helpers.each(Chart.instances, function(chart) {
                    ...
                    chart.data.datasets.forEach(function(dataset) {
                        if(theChartLabel === 'WeeklyInit'){
                            console.log(dataset);
                            chart.config.data.labels = ["AntenatalCare","PostNatalCare","SelfDelivery","GenderBasedViolence","RapeCases","FamilyPlanning","PrenatalCare"];
                            dataset.data = [totalAntenatalCareExpenses, totalPostNatalCareExpenses, totalSelfDeliveryExpenses, totalGenderBasedViolenceExpenses, totalRapeCasesExpenses, totalFamilyPlanningExpenses, totalPrenatalCareExpenses];
