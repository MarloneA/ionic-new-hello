   ...
   //Adjust page chart height
            ...
            $timeout(function(){
                ...
                var showWksTabChart = setInterval(function(){
                    ...
                    if(showWksTab.length>0){
                        $location.hash('donorexp-active-tab-pill-button');
    ...
    FBExpensesref.orderByKey().on("value", function(snapshot) {
        ...
        var returnData = {
                            "28-1-2019": {
                                "-LXHo2MQ_OZJlRZQxDUw": {
                                    ...
                                    "itemCost": 5000,
                                    "itemDesc": "Normal Delivery",
                                    "itemID": 1,
                                    "itemType": "Safe MotherHood",
                                    "item_Desc": "Mosquito nets",
                                    "time": "7:55",
                                    "ts": 1548651355000
                                }
                            }
        ...
        $scope.monthlyBarCharts = function() {
            ...
            $timeout(function(){
                console.log('8888');
                $location.hash('donorexp-active-tab-pill-button-month');
                $ionicScrollDelegate.anchorScroll(true);
            },1000);
        ...
        $scope.yearlyBarCharts = function() {
            ...
            $timeout(function(){
                console.log('8888');
                $location.hash('donorexp-active-tab-pill-button-year');
                $ionicScrollDelegate.anchorScroll(true);
            },1000);
        };
        ...
        $interval(function() {
            ...
            console.log(dailyExpenses);
            console.log('$scope.dailyExpenses');
            console.log(JSON.stringify(dailyExpenses));

            $scope.theMonthlyExpenses = sortbydate(dailyExpenses);

            // $scope.theMonthlyExpenses = [{
            //     "28-01-2019": [],
            //     "dayTotal": 5000,
            //     "expCount": 1,
            //     "$$hashKey": "object:185"
            ...
            console.log('$scope.theReportMonthlyExpenses');
