   ...
   //Adjust page chart height
    ...
    FBSalesref.orderByKey().on("value", function(snapshot) {
        ...
        (function($){
            //Make sure week tabs are loaded before running currentWkChart()
            var showWksTabChart = setInterval(function(){
                var showWksTab = $('#dashboard-content.the-revenue-report md-card');
                ...
                if(showWksTab.length>0){
                    ...
                    setTimeout(function() {
                        ...
                        $('.the-revenue-report [data-toggle-box]').unbind('click');

                        $('.the-revenue-report [data-toggle-box]').on('click', function() {
                            ...
                            if(exeCount<1){
                                if ($('.the-revenue-report #' + toggle_box).is(":visible")) {
                                    $('.the-revenue-report #' + toggle_box).slideUp(250);
                                    console.log('isvisible');
                                } else {
                                    $(".the-revenue-report [id^='box']").slideUp(250);
                                    $('.the-revenue-report #' + toggle_box).slideDown(250);
