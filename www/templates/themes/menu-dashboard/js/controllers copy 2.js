...
appControllers.controller('expenseReportCtrl', function(APIBASE, $firebaseArray, $firebaseObject, $scope, $rootScope, $timeout, $http, $filter, $q, $interval, $state, $stateParams, $ionicHistory) {
            ...
            */
            ...
            weeksData.forEach(function(item, index) {
                ...
                if((theDay >= (theFirstWeekDate) && theMonth == (theFirstDayWeekMonth+1)) && (theDay <= (theLastWeekDate) && theMonth == (theLastDayWeekMonth+1))){
                    ...
                    var futureDays = d.getDate()-theFirstWeekDate;

                    for (var i = 0; i < (7-(futureDays)); i++) {
        ...
        */
        ...
        FBExpensesref.orderByKey().on("value", function(snapshot) {
            ...
            for (var i = 0; i < dailyExpenses.length; i++) {
                ...
                dailyExpenses[i]['expCount'] = dailyExpenses.length;
            }
