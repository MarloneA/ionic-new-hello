    ...
    //}
        ...
        FBBudgetref.orderByKey().on("value", function(snapshot) {
            ...
            setTimeout(function() {
                ...
                FBExpensesref.orderByKey().on("value", function(snapshot) {
                            ...
                            budgetData.forEach(function(item) {
                                if(item['itemType'] == budgetTypes[i]['title']){
                                    ...
                                    if(item['itemDur']==budgetDur){
                                        ...
                                        monthlyBudget = monthlyBudget+(item['itemCost']/1);

                                        console.log('totalBudgetttt5: '+totalBudget);
                                    }else if (item['itemDur']==switchDuration){
                                        weeklyBudget = weeklyBudget+(item['itemCost']/1);
                                        //totalBudget = totalBudget;//+(item['itemCost']/1);
                                        console.log('totalBudgetttt: '+totalBudget);
                                        console.log('totalBudgetttt2: '+item['itemCost']);

                                        console.log('totalBudgetttt3: '+totalBudget);
                                    }

                                    //Refined Monthly Budget Totals
                                        if (item['itemDur']=='week'){
                                            cumMonthlyBudgetA = cumMonthlyBudgetA+(item['itemCost']/1);
                                            //totalBudget = totalBudget;//+(item['itemCost']/1);

                                            cumBudgetItemActA = item['itemAct'];
                                            cumBudgetItemTypeA = item['itemType'];
                                            console.log('monthlyBudgetqqqqq: '+monthlyBudget);
                                            console.log('totalBudgetttt: '+totalBudget);
                                            console.log('totalBudgetrrrr2: '+item['itemCost']);

                                            console.log('totalBudgetttt3: '+totalBudget);
                                        }

                                        if (item['itemDur']=='month'){
                                            cumMonthlyBudgetB = cumMonthlyBudgetB+(item['itemCost']/1);
                                            //totalBudget = totalBudget;//+(item['itemCost']/1);

                                            cumBudgetItemActB = item['itemAct'];
                                            cumBudgetItemTypeB = item['itemType'];
                                            console.log('monthlyBudgetqqqqq: '+monthlyBudget);
                                            console.log('totalBudgetttt: '+totalBudget);
                                            console.log('totalBudgetrrrr2: '+item['itemCost']);
                                        ...
                                        if((cumBudgetItemActA == cumBudgetItemActB)&&(cumBudgetItemTypeA == cumBudgetItemTypeB)){
                                            cumBudgetItemDiff = cumBudgetItemDiff + (cumMonthlyBudgetB - cumMonthlyBudgetA);
                                        }
                                    //End of Refined Monthly Budget Totals
                                    ...
                                    if(weeklyBudget>monthlyBudget){
                                        totalBudget = totalBudget + cumBudgetItemDiff;
                                    }else{
                                        totalBudget = totalBudget;
                                    }

                                    console.log('totalBudgetttt4: '+totalBudget);
                                    console.log('monthlyBudget: '+monthlyBudget);
                                    console.log('weeklyBudget: '+weeklyBudget);

                                    // else if (item['itemCost']<1){
                                    //     totalBudget = (item['itemCost']/1);
                                    // }
                    ...
                    currentYrChart_old = function(budgetDur){
                        ...
                        for (var i = 0; i < budgetTypes.length; i++) {
                            ...
                            budgetData.forEach(function(item) {
                                if(item['itemType'] == budgetTypes[i]['title']){
                                    ...
                                    console.log('budgetDurrrrr: '+budgetDur);
                                    ...
                                    if(item['itemDur']==budgetDur){
                                        //totalBudget = (item['itemCost']/1);
                                        yearlyBudget = yearlyBudget+(item['itemCost']/1);
                                        activityBudgetsYr.push({
                                            'activity':item['itemAct'],
                                            'actBudget':item['itemCost'],
                                        })

                                        console.log('totalBudgetttt5: '+yearlyBudget);
                                        thefinalYrBudget = yearlyBudget;
                                    }

                                    if (item['itemDur']=='month'){
                                        monthlyBudget = monthlyBudget+(item['itemCost']/1);
                                        //totalBudget = totalBudget;//+(item['itemCost']/1);
                                        activityBudgetsMth.push({
                                            'activity':item['itemAct'],
                                            'actBudget':item['itemCost'],
                                        })
                                    ...
                                    //Refined Monthly Budget Totals
                                        ...
                                        if (item['itemDur']=='year'){
                                            cumMonthlyBudgetC = cumMonthlyBudgetC+(item['itemCost']/1);
                                            //totalBudget = totalBudget;//+(item['itemCost']/1);

                                            cumBudgetItemActC = item['itemAct'];
                                            cumBudgetItemTypeC = item['itemType'];
                                            console.log('monthlyBudgetqqqqq: '+monthlyBudget);
                                            console.log('totalBudgetttt: '+totalBudget);
                                            console.log('totalBudgetrrrr2: '+item['itemCost']);
                                        ...
                                        if((cumBudgetItemActC == cumBudgetItemActA)&&(cumBudgetItemTypeC == cumBudgetItemTypeA)){
                                            cumBudgetItemDiff = cumBudgetItemDiff + (cumMonthlyBudgetB - cumMonthlyBudgetA);
                                        }

                                        if((cumBudgetItemActC == cumBudgetItemActB)&&(cumBudgetItemTypeC == cumBudgetItemTypeB)){
                                            cumBudgetItemDiff = cumBudgetItemDiff + (cumMonthlyBudgetB - cumMonthlyBudgetA);
                                        }
                                    ...
                                    if (item['itemDur']=='week'){
                                        weeklyBudget = weeklyBudget+(item['itemCost']/1);
                                        //totalBudget = totalBudget;//+(item['itemCost']/1);
                                        activityBudgetsWk.push({
                                            'activity':item['itemAct'],
                                            'actBudget':item['itemCost'],
                                        })

                                        console.log('weeklyBudgetqqqqq: '+weeklyBudget);
                                        console.log('yearlyBudgettt: '+yearlyBudget);
                                        console.log('totalBudgetttt: '+totalBudget);
                                        console.log('totalBudgetrrrr2: '+item['itemCost']);
                                    ...
                                    //yearlyBudget = thefinalYrBudget

                                    if(yearlyBudget<monthlyBudget){
                                        totalBudgetA = monthlyBudget;
                                    }else {
                                        totalBudget = thefinalYrBudget;
                                    }

                                    if(yearlyBudget<weeklyBudget){
                                        totalBudgetB = weeklyBudget;
                                    }else {
                                        totalBudget = thefinalYrBudget;
                                    } 

                                    if(totalBudgetA>totalBudgetB){
                                        totalBudget = totalBudgetA;
                                    }else{
                                        totalBudget = totalBudgetB;
                                    }

                                    if(thefinalYrBudget>monthlyBudget){
                                        totalBudget = thefinalYrBudget;
                                    }

                                    console.log('totalBudgetA: '+totalBudgetA);
                                    console.log('totalBudgetB: '+totalBudgetB);
                                    console.log('weeklyBbbbb: '+weeklyBudget);
                                    console.log('weeklyCcccc: '+monthlyBudget);
                                    console.log('weeklyAaaaa: '+yearlyBudget);
                                    console.log('totalBudgetAAA: '+totalBudget);


                                    if((monthlyBudget>yearlyBudget)||(weeklyBudget>yearlyBudget)){
                                        totalBudget = totalBudget + cumBudgetItemDiff;
                                    }else{
                                        totalBudget = totalBudget;
                                    }

                                    console.log('totalBudgetttt511: '+totalBudget);
                                    console.log('cumBudgetItemDiff: '+cumBudgetItemDiff);
                                    console.log('monthlyBudget: '+monthlyBudget);
                                    console.log('weeklyBudget: '+weeklyBudget);
                    ...
                    currentYrChart = function(budgetDur){
                        ...
                        var allBudgetActivities = ["AntenatalCare_Activity 1","PostNatalCare_Activity 1","SelfDelivery_Activity 1","GenderBasedViolence_Activity 1","RapeCases(GVRC)_Activity 1","FamilyPlanning_Activity 1","AntenatalCare_Activity 1","PrenatalCare_Activity 1","AntenatalCare_Activity 2","PostNatalCare_Activity 2","SelfDelivery_Activity 2","GenderBasedViolence_Activity 2","RapeCases(GVRC)_Activity 2","FamilyPlanning_Activity 2","AntenatalCare_Activity 2","PrenatalCare_Activity 2","AntenatalCare_Activity 3","PostNatalCare_Activity 3","SelfDelivery_Activity 3","GenderBasedViolence_Activity 3","RapeCases(GVRC)_Activity 3","FamilyPlanning_Activity 3","AntenatalCare_Activity 3","PrenatalCare_Activity 3"];

                        var profiledActivities = allBudgetActivities;//[];
                        ...
                        console.log('allBudgetActivities__');
                        console.log(allBudgetActivities);
                        ...
                        for (var i = 0; i < budgetTypes.length; i++) {
                            ...
                            budgetData.forEach(function(item) {
                                if(item['itemType'] == budgetTypes[i]['title']){
                                    ...
                                    /*
                                        if((item['itemDur'] == 'year')){
                                            //if(((budgetKey+'_'+item['itemAct']) == (allBudgetActivities[y]))&&(item['itemDur'] == 'year')){
                                            //console.log('totalBudgetYear: '+totalTargetBudget);
                                            console.log('totalBudgetCostYear: '+item['itemCost']);


                                            console.log('before_profiledActivities');
                                            console.log(profiledActivities);

                                            // var index = profiledActivities.indexOf(allBudgetActivities[y]);
                                            // if (index > -1) {
                                            //   profiledActivities.splice(index, 1);
                                            // }

                                            totalTargetBudgetYr = totalTargetBudgetYr+item['itemCost'];

                                            console.log('totalTargetBudgetYr: '+totalTargetBudgetYr+" : ");
                                            console.log('profiledActivitiesLLL: '+profiledActivities.length);
                                            console.log(profiledActivities);


                                            // newProfiledActs.push(JSON.stringify(profiledActivities));
                                            newBudgetTotals.push({
                                                                    'activityID':(budgetKey+'_'+item['itemAct']),
                                                                    'totalBudget':totalTargetBudgetYr
                                                                });


                                            // profiledActivities.forEach(function(theDepItemAct) {
                                            //     if((item['itemAct'] == theDepItemAct)&&(item['itemDur'] == 'month')){
                                            //         console.log('totalBudgetMonth: '+totalTargetBudget);
                                            //         console.log('totalBudgetCostMonth: '+item['itemCost']);
                                            //         totalTargetBudget = totalTargetBudget+item['itemCost'];

                                            //         var index = profiledActivities.indexOf(theItemAct);
                                            //         if (index > -1) {
                                            //           profiledActivities.splice(index, 1);
                                            //         }

                                            //         profiledActivities.forEach(function(theKeyDepItemAct) {
                                            //             if((item['itemAct'] == theKeyDepItemAct)&&(item['itemDur'] == 'week')){
                                            //                 console.log('totalBudgetMonth: '+totalTargetBudget);
                                            //                 console.log('totalBudgetCostMonth: '+item['itemCost']);
                                            //                 totalTargetBudget = totalTargetBudget+item['itemCost'];
                                            //             }
                                    ...
                                    */
                                    ...
                                    /*
                                        for (var y = 0; y < allBudgetActivities.length; y++) {

                                            //allBudgetActivities.forEach(function(theItemAct) {
                                            //k++;
                                            console.error(budgetTypes[i]['title']);
                                            console.log('theItemAct: '+allBudgetActivities[y]);

                                            console.log('theKKKKKKKK: '+totalTargetBudget+" : "+y+" : "+allBudgetActivities.length);




                                            console.log(newBudgetTotals);
                                            console.log('theWWWWWWWWW: '+y);
                                ...
                                //if(y>allBudgetActivities.length-2){
                                ...
                                /*
                                    $timeout(function() {
                                        ...
                                        budgetData.forEach(function(item_budget) {

                                            console.log(newProfiledActs);
                                            console.log('SDFGHJK');
                                            console.log(profiledActivities);
                                            JSON.parse(newProfiledActs[0]).forEach(function(theDepItemAct) {

                                                    console.log('before_profiJJJJsAAAA: '+totalTargetBudget+" : ");
                                                    console.error(((budgetKey+'_'+item_budget['itemAct'])+" : "+(theDepItemAct)))


                                                if(((budgetKey+'_'+item_budget['itemAct']) == (theDepItemAct))&&(item_budget['itemDur'] == 'month')){
                                                    //console.log('totalBudgetYear: '+totalTargetBudget);
                                                    console.log('totalBudgetCostYear: '+item_budget['itemCost']);


                                                    console.log('before_profiledActivitiesAAAA: '+totalTargetBudget+" : ");
                                                    console.log('before_profiledActivitiesBBBBAAAA: '+profiledActivities.length);

                                                    // var index = profiledActivities.indexOf(theDepItemAct);
                                                    // if (index > -1) {
                                                    //   profiledActivities.splice(index, 1);
                                                    // }

                                                    totalTargetBudget = totalTargetBudget+item_budget['itemCost'];
                                                    console.log('totalTargetBudgetRRR: '+totalTargetBudget);
                                                    totalTargetBudget = newBudgetTotals[0] + totalTargetBudget;

                                                    console.log(JSON.parse(newProfiledActs[0]));
                                                    console.log('profiledActivities');
                                                    console.log(profiledActivities);
                                                }
                                            });
        ...
        $scope.addBudgetAnalysisDialog = function($event,item) {
            ...
            for (var i = 0; i < mergedActCosts.length; i++) {
                ...
                dataAllAttr.push({
                    'label':mergedActCosts[i]['activity'],
                    'value':mergedActCosts[i]['actCost'],
                    'budgetlabel':mergedActBudgets[i]['activity'],
                    'budgetvalue':mergedActBudgets[i]['actCost'],
                    'color':{'color':sampleColors[i]},
                });
                amountSpent.push(mergedActCosts[i]['actCost']);
                amountBudgeted.push(mergedActBudgets[i]['actCost']);
            }
