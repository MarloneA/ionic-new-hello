   ...
   //END OF CUSTOM CODE
    ...
    //}
                        ...
                        for (var i = 0; i < budgetTypes.length; i++) {
                            ...
                            budgetData.forEach(function(item) {
                                if(item['itemType'] == budgetTypes[i]['title']){
                                    ...
                                    //     totalBudget = 0;//totalBudget+(item['itemCost']/4);
                                    // }
        ...
        $scope.addBudgetAnalysisDialog = function($event,item) {
            ...
            var mergerActivities = function(availableActivities){
                var arr = item.activities;

                var holder = {};

                arr.forEach(function (d) {
                    availableActivities.forEach(function (act) {
                        if(act==d.activity){
            ...
            var mergerBudgetsActivities = function(){
                ...
                console.log('budget_Dur:'+budgetDur);
                ...
                for(var prop in holder) {
                    availableActivities.push(prop);
                    mergedActBudgets.push({activity: prop, actCost: holder[prop]});   
                }


                console.log('mergedAct_Budgets:'+mergedActBudgets);
                console.log(mergedActBudgets);


                mergerActivities(availableActivities);
